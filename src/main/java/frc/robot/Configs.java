...
public final class Configs {
        ...
        public static final class IntakeSubsystem {
                ...
                // public static final SparkFlexConfig IntakeRightMotorConfig = new
                // SparkFlexConfig();

                static {

                        IntakeMotorLeftConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(50).voltageCompensation(12);
                        IntakeMotorRightConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(50).voltageCompensation(12)
                                        .follow(IntakeConstants.INTAKE_LEFT_ID, true);
                        ...
                        IntakeMotorLeftConfig.closedLoop.maxMotion.maxAcceleration(1000000);
                        ...
                        IntakeMotorRightConfig.closedLoop.maxMotion.maxAcceleration(1000000);
        ...
        public static final class FunnelSubsystem {
                ...
                static {
                        ...
                        FunnelMotorConfig.closedLoop.maxMotion.maxAcceleration(100000);
        ...
        public static final class ClimberSubsystem {
                ...
                static {
                        ...
                        ClimbMotorLeftConfig.closedLoop
                                        ...
                                        .d(0)
                                        .outputRange(-1, 1);
                        ClimbMotorLeftConfig.closedLoop.maxMotion
        ...
        public static final class PushoutSubsystem {
                ...
                // public static final SparkFlexConfig PushoutMotorAgitateConfig = new
                // SparkFlexConfig();
                // public static final SparkFlexConfig PushoutRightMotorConfig = new
                // SparkFlexConfig();
                ...
                static {
                        ...
                        PushoutMotorConfig.closedLoop.maxMotion
        ...
        public static final class KickerSubsystem {
                ...
                static {
                        ...
                        kickerLeftMotorConfig.closedLoop.maxMotion.maxAcceleration(1000000);
                        ...
                        kickerRightMotorConfig.closedLoop.maxMotion.maxAcceleration(1000000);
                }
        ...
        public static final class ShooterSubsystem {
                ...
                static {
                        ...
                        ShooterRightMotor1Config.idleMode(IdleMode.kCoast).smartCurrentLimit(50)
                        ...
                        ShooterRightMotor1Config.closedLoop.maxMotion.maxAcceleration(10000);
                        ...
                        ShooterRightMotor2Config.closedLoop.maxMotion.maxAcceleration(10000);
                        ...
                        ShooterLeftMotor1Config.closedLoop.maxMotion.maxAcceleration(10000);
                        ...
                        ShooterLeftMotor2Config.closedLoop.maxMotion.maxAcceleration(10000);
        ...
        public static final class HopperSubsystem {
                ...
                static {
                        ...
                        TwindexerRightControllerConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(40)
                                        .voltageCompensation(12).follow(HopperConstants.TWINDEXER_LEFT_ID, true);
                        TwindexerLeftControllerConfig.idleMode(IdleMode.kBrake).smartCurrentLimit(40)
                                        .voltageCompensation(12);
                        ...
                        TwindexerRightControllerConfig.closedLoop.maxMotion.maxAcceleration(100000);
                        ...
                        TwindexerLeftControllerConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder)
                                        ...
                                        .kV(HopperConstants.v)
                                        .kA(HopperConstants.a);
                        TwindexerLeftControllerConfig.closedLoop.maxMotion.maxAcceleration(100000);
                        // Set PID values for velocity control in slot 1
                        // .p(0.0001, ClosedLoopSlot.kSlot1)
                        // .i(0, ClosedLoopSlot.kSlot1)
                        // .d(0, ClosedLoopSlot.kSlot1)
