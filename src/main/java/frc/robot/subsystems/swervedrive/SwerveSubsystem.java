...
public class SwerveSubsystem extends SubsystemBase {
  ...
  /**
   * Processes a single Limelight camera for pose estimation.
   * Uses MT2 when useMegaTag2 is true, MT1 as fallback.
   */
  private void updateCamera(String limelightName) {
    ...
    if (useMegaTag2) {
      ...
      if (!doRejectUpdate) {
        lastMT1Heading = mt1.pose.getRotation();
  ...
  /** Updates the field relative position of the robot. Uses MT2 by default, MT1 as fallback toggle. */
  public void updateOdometry() {

    updateCamera("limelight-bleft");
    updateCamera("limelight-bright");
    updateCamera("limelight-climber");
