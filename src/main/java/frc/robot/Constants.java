...
public final class Constants {
  ...
  public static class PushoutConstants {
    ...
    public static final double PUSHOUT_EXTENDED_POS = 20.206;// 15.911; // TUNE THIS!!!
    public static final double PUSHOUT_RIGHT_EXTENDED_POS = -20.206; // TUNE THIS!!!
  ...
  public static class ShooterConstants {
    ...
    public static final double SHOOTER_SPEED = -1805;                  // RPM 3 meters 1900 4 meters 2200
